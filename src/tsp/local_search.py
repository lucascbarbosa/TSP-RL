...
class LocalSearch:
    """
    Local search algorithms for TSP improvement.

    Implements:
        - 2-opt: Classic edge exchange heuristic.
        - Lin-Kernighan: Variable-depth chain of 2-opt moves.
    """
    ...
    def _apply_two_opt(self, tour: List[int], i: int, j: int) -> List[int]:
        """
